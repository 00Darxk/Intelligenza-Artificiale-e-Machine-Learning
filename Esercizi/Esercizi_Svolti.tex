...
%% TODO se soddisfa la condizione di consistenza, allora soddisfa anche la condizione di ammissibilità 
...
I nodi rossi sono quelli nella frontiera, i nodi blu sono i nodi nella frontiera da espandere, ed i nodi verdi sono i nodi del percorso individuato come soluzione:

\begin{figure}[H]%
    \centering%
    \includegraphics[trim={4cm 0 0 0},scale=0.7]{albero_esercitazione_1.pdf}%
\end{figure}
...
%% TODO codice python algoritmo greedy 
