...
Un altro momento cruciale fu la vittoria di AlphaGO, sviluppato da Deep Mind, divisione di Google, quando ha battuto il campione del gioco di Go, le cui configurazioni 
sono molte di più del gioco di scacchi. 

%% TODO add 15 nov fine lezione
