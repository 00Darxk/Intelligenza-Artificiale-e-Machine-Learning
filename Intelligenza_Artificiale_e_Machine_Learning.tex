...
%% TODO img matrice di confusione
...
%% TODO img processo di training (anche per regressione lineare senza estrazione delle features)
...
%% TODO img insieme convesso caso bidimensionale (retta)
% \begin{figure}[H]%
%     \centering%
%     \includegraphics{}%
% \end{figure}
...
%% TODO img funzione convessa caso monodimensionale (parabola) 
% \begin{figure}[H]%
%     \centering%
%     \includegraphics{}%
% \end{figure}

%% TODO add strongly convex (saltata nel programma)
...
\end{equation*}
%% TODO img proprietà funzione convessa caso monodimensionale (parabola) 
% \begin{figure}[H]%
%     \centering%
%     \includegraphics{}%
% \end{figure}
...
%% TODO img gradiente funzione convessa caso bidimensionale (paraboloide) 
% \begin{figure}[H]%
%     \centering%
%     \includegraphics{}%
% \end{figure}
...
%% TODO img derivate direzionale funzione convessa caso bidimensionale (paraboloide) 
% \begin{figure}[H]%
%     \centering%
%     \includegraphics{}%
% \end{figure}
...
In generale la dimensione $d$ della gaussiane dipende dal numero delle features, ed il numero delle gaussiane dal numero di classi. %% TODO check
...
% th di bayes, prob a posteriori calcolare, distinzione da probabilità e densità 
% probabilità condizionale p(x|w) è il problema, quella a priori ed assoluta no
% si può stimare 
% quando applicare l'uno e l'altro

% Stimare la classe di appartenenza di un pattern, date due feature, ed una distribuzione in apprendimento supervisionato. Ogni campione è descritto con un etichetta. 
% Per stimare il vettore medio e la matrice di covarianza si usano le formule, da ricordare: 
% Media sui vari componenti del vettore e matrice. 
% Vettore medio solamente media, per le covarianze $\sigma_{ij}$: valore medio differenza quadratica $(x_i-\mu_i)(x_j-\mu_j)$. 
% Fornisce informazione sulla rotazione dell'ellisse se $i\neq j$, mentre varianza per $i=j$. Se non si ha la probabilità a priori si può assumere equiprobabile. 
% Si stima dai campioni in caso. La probabilità condizionale si ottiene dalla gaussiana inserendo i parametri per le due classi. La media pesata di queste rispetto alla probabilità delle classi rappresenta la probabilità assoluta stimata. Si ottiene poi le due probabilità con il sistema di bayes, dopo aver controllato che la probabilità di ognuna delle due classi sommata sia pari ad uno. 

% In caso d maggiore di due descrivere cosa bisogna calcolare, senza effettuarlo. 

%% TODO aggiungere ex su esercizi ^^^
...
%% TODO definizione matematica Kernel
