...
\begin{tikzpicture}
    ...
    \draw
        ...
        (0.7,0.2)node[circle, draw, fill=OliveGreen, OliveGreen, inner sep=1.5pt]{}
...
\begin{tikzpicture}
    ...
    \addplot[blue, smooth, domain=-5:5, blue]{-0.3*x} node[pos=0.95](f2){};
    \addplot[blue, smooth, domain=-5:5, OliveGreen]{0.5*x*sin(-180*(x+4)/pi)} node[pos=0.95](f2){};
    \end{axis}
\end{tikzpicture}
\end{document}